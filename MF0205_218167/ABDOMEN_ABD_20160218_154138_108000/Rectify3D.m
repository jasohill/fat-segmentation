...
NIFTI_file_name_F_upper = '20160218_154138t1vibedixontrap4bh320s004a1001.nii.gz';
NIFTI_file_name_W_upper = '20160218_154138t1vibedixontrap4bh320s005a1001.nii.gz';
NIFTI_file_name_F_lower = '20160218_154138t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_lower = '20160218_154138t1vibedixontrap4bh320s010a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0004/20160218_154138t1vibedixontrap4bh320s004a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0005/20160218_154138t1vibedixontrap4bh320s005a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20160218_154138t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20160218_154138t1vibedixontrap4bh320s010a1001.nii';

NIFTI_file_name_F_upper_reslice = '20160218_154138t1vibedixontrap4bh320s004a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20160218_154138t1vibedixontrap4bh320s005a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20160218_154138t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20160218_154138t1vibedixontrap4bh320s010a1001_resliced.nii';
...
upperBottom = 9;
Z_L3_L4u    = 6;  % middle of L3-L4 intervertebral disk slice (upper scan)
Z_L2_L3u    = 17; % middle of L2-L3 intervertebral disk slice (upper scan)
Z_L1_L2u    = 28; % middle of L1-L2 intervertebral disk slice (upper scan)
Z_T12_L1    = 39; % middle of T12-L1 intervertebral disk slice (upper scan)
Z_T11_T12   = 49; % middle of T11-T12 intervertebral disk slice (upper scan)
Z_T10_T11   = 58; % middle of T10-T11 intervertebral disk slice (upper scan)
Z_T9_T10    = 67; % middle of T9-T10 intervertebral disk slice (upper scan)
Z_T8_T9     = 75; % middle of T8-T9 intervertebra disk slice (use for bottom of thoracic cavity) 
upperTop    = 112;

% NOTE: diaphraim is at slices = 
% - register from the bottom of T8
heartMax  = upperTop - 78 + 1;
heartApex = upperTop - 67 + 1;
...
lowerTop = 117;
lastSlice = 49;  % lowest slice without clipping

lowerSlices = lowerTop:-1:lowerBottom;

% correct scan offset
scanOffset = 88   %Z_L1_L1 - Z_L1_L1u
...
foregroundThresholdV  = 190; %175; %103;
...
innerVeto(112:120) = 261 - 184;
innerVeto(110:111) = 261 - 185;
innerVeto(108:109) = 261 - 186;
innerVeto(106:107) = 261 - 187;
innerVeto(105)    = 261 - 188;
innerVeto(104)    = 261 - 189;
innerVeto(103)    = 261 - 190;
innerVeto(102)    = 261 - 191;
innerVeto(101)    = 261 - 192;
innerVeto(99:100) = 261 - 193;
innerVeto(97:98)  = 261 - 194;
innerVeto(94:96)  = 261 - 195;
innerVeto(92:93)  = 261 - 196;
innerVeto(90:91)  = 261 - 197;
innerVeto(87:89)  = 261 - 198;
innerVeto(85:86)  = 261 - 199;
innerVeto(83:84)  = 261 - 200;
innerVeto(77:82)  = 261 - 201;
...
notLungDilate  = 55; %45%42%21;
innerDilate    = 4; %13;
heartShift     = 40;
heartDilate    = 50; %45 %42
heartAreaThreshold = 400;
CATareaThreshold = 50; %160
...
% CATdilateCorrect(heartMax+1:heartMax+2) = +2;
...
% vertical section
aortaSeed(261-134,165,40:43)   = 1;
aortaSeed(261-133,166,44:47)   = 1;
aortaSeed(261-133,167,48:50)   = 1;
aortaSeed(261-132,167,51:52)   = 1;
aortaSeed(261-131,167,53:54)   = 1;
aortaSeed(261-132,167,55:56)   = 1;
aortaSeed(261-132,167,57:58)   = 1;
aortaSeed(261-131,167,59)      = 1;
aortaSeed(261-130,167,60:66)   = 1;
aortaSeed(261-129,169,67:69)   = 1;
aortaSeed(261-128,170,70:73)   = 1;
aortaSeed(261-127,171,74:76)   = 1;
aortaSeed(261-127,171,77:80)   = 1;
aortaSeed(261-125,172,81)      = 1;
aortaSeed(261-124,172,82)      = 1;
aortaSeed(261-123,172,83:84)   = 1;
aortaSeed(261-122,172,85:86)   = 1;
aortaSeed(261-121,173,87:88)   = 1;
aortaSeed(261-120,173,89:90)   = 1; 
aortaSeed(261-119,174,91:104)  = 1;
aortaSeed(261-120,175,105:106) = 1;
aortaSeed(261-121,175,107:upperTop) = 1;
% curved section
aortaSeed(261-120,171,108:upperTop) = 1;
aortaSeed(261-125,172,108:upperTop) = 1;
aortaSeed(261-128,170,108:upperTop) = 1;
aortaSeed(261-135,168,108:upperTop) = 1;
aortaSeed(261-141,164,108:upperTop) = 1;
aortaSeed(261-143,159,108:upperTop) = 1;
aortaSeed(261-143,154,108:upperTop) = 1;
aortaSeed(261-149,152,108:upperTop) = 1;
%aortaSeed(261-149,165,109:upperTop) = 1;
...
save subject05_i_registered.mat;