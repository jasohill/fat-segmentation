...
NIFTI_file_name_F_upper = '20151016_151816t1vibedixontrap4bh320s013a1001.nii.gz';
NIFTI_file_name_W_upper = '20151016_151816t1vibedixontrap4bh320s014a1001.nii.gz';
NIFTI_file_name_F_lower = '20151016_151816t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_lower = '20151016_151816t1vibedixontrap4bh320s010a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0013/20151016_151816t1vibedixontrap4bh320s013a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0014/20151016_151816t1vibedixontrap4bh320s014a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20151016_151816t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20151016_151816t1vibedixontrap4bh320s010a1001.nii';

NIFTI_file_name_F_upper_reslice = '20151016_151816t1vibedixontrap4bh320s013a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20151016_151816t1vibedixontrap4bh320s014a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20151016_151816t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20151016_151816t1vibedixontrap4bh320s010a1001_resliced.nii';
...
% Z_L1b       = 22;  % bottom of L1 vertebra slice
Z_T9_T10t   = 52;  % top of T9-T10 intervertebral disk slice (use for bottom of thoracic cavity) 
...
lowerOffset = 15;
FH       = 17;   % widest slice of the formoral head
Z_L5_S1b = 55;   % bottom of L5-S1 intervertebral disk slice
lastSlice = 53;  % last slice with no clipping
Z_L4_L5  = 75;   % middle of L4-L5 intervertebral disk slice
UM       = 90;   % umbilicus (belly button)
Z_L3_L4  = 88;   % middle of L3-L4 intervertebral disk slice
Z_L2_L3  = 101;  % middle of L2-L3 intervertebral disk slice
...
% correct scan offset
scanOffset = 92   %Z_L1_L2 - Z_L1_L2u
...
innerVeto(113:114) = 261 - 174;
innerVeto(112)     = 261 - 175;
innerVeto(111)     = 261 - 176;
innerVeto(110)     = 261 - 177;
innerVeto(109)     = 261 - 178;
innerVeto(108)     = 261 - 179;
innerVeto(107)     = 261 - 180;
innerVeto(105:106) = 261 - 181;
innerVeto(103:104) = 261 - 182;
innerVeto(101:102) = 261 - 183;
innerVeto(99:100)  = 261 - 184;
innerVeto(97:98)   = 261 - 185;
innerVeto(96)      = 261 - 186;
innerVeto(95)      = 261 - 187;
innerVeto(93:94)   = 261 - 188;
innerVeto(91:92)   = 261 - 189;
innerVeto(88:90)   = 261 - 190;
innerVeto(86:87)   = 261 - 191;
innerVeto(82:85)   = 261 - 192;
innerVeto(77:81)   = 261 - 193;
innerVeto(75:76)   = 261 - 194;
innerVeto(70:74)   = 261 - 195;
innerVeto(65:69)   = 261 - 196;
...
% vertical section
aortaSeed(261-116,166,40:51)   = 1;
aortaSeed(261-115,166,52:56)   = 1;
aortaSeed(261-114,166,57:58)   = 1;
aortaSeed(261-114,167,59:62)   = 1;
aortaSeed(261-114,167,63:66)   = 1;
aortaSeed(261-113,167,67:68)   = 1;
aortaSeed(261-112,167,69:72)   = 1;
aortaSeed(261-111,167,73:77)   = 1;
aortaSeed(261-110,167,78:81)   = 1;
aortaSeed(261-109,168,81:82)   = 1;
aortaSeed(261-108,168,83:84)   = 1;
aortaSeed(261-109,168,85:91)   = 1; 
aortaSeed(261-110,169,92:95)   = 1;
aortaSeed(261-111,170,96:98)   = 1;
aortaSeed(261-112,170,99:100)  = 1;
aortaSeed(261-113,170,101)     = 1;
aortaSeed(261-114,171,102:103) = 1;
% curved section
aortaSeed(261-144,164,103)         = 1;
aortaSeed(261-148,163,102:upperTop) = 1;
aortaSeed(261-141,169,102:upperTop) = 1;
aortaSeed(261-135,171,102:upperTop) = 1;
aortaSeed(261-132,175,102:upperTop) = 1;
aortaSeed(261-126,175,102:upperTop) = 1;
aortaSeed(261-114,172,104)          = 1;
aortaSeed(261-116,172,105:upperTop) = 1;
...
save subject02_i_registered.mat;