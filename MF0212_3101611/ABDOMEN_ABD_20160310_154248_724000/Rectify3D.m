...
NIFTI_file_name_F_upper = '20160310_154248t1vibedixontrap4bh320s004a1001.nii.gz';
NIFTI_file_name_W_upper = '20160310_154248t1vibedixontrap4bh320s005a1001.nii.gz';
NIFTI_file_name_F_lower = '20160310_154248t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_lower = '20160310_154248t1vibedixontrap4bh320s010a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0004/20160310_154248t1vibedixontrap4bh320s004a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0005/20160310_154248t1vibedixontrap4bh320s005a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20160310_154248t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20160310_154248t1vibedixontrap4bh320s010a1001.nii';

NIFTI_file_name_F_upper_reslice = '20160310_154248t1vibedixontrap4bh320s004a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20160310_154248t1vibedixontrap4bh320s005a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20160310_154248t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20160310_154248t1vibedixontrap4bh320s010a1001_resliced.nii';
...
UM       = 87;   % umbilicus (belly button)
Z_L2_L3  = 104;  % middle of L2-L3 intervertebral disk slice
Z_L1_L2  = 115;  % middle of L1-L2 intervertebral disk slice
%Z_L1_L2t    = 118; % top of L2 vertebra disk
lowerTop = 114;
lastSlice = 46;  % lowest slice without clipping
...
innerVeto(115:120) = 261 - 173;
innerVeto(114:113) = 261 - 174;
innerVeto(111:112) = 261 - 175;
innerVeto(110:111) = 261 - 176;
innerVeto(109)     = 261 - 177;
innerVeto(107:108) = 261 - 178;
innerVeto(106)     = 261 - 179;
innerVeto(105)     = 261 - 180;
innerVeto(104)     = 261 - 181;
innerVeto(103)     = 261 - 182;
innerVeto(102)     = 261 - 183;
innerVeto(101)     = 261 - 184;
innerVeto(100)     = 261 - 185;
innerVeto(99)      = 261 - 186;
innerVeto(98:97)   = 261 - 187;
innerVeto(95:96)   = 261 - 188;
innerVeto(93:94)   = 261 - 189;
innerVeto(91:92)   = 261 - 190;
innerVeto(85:90)   = 261 - 191;
innerVeto(81:84)   = 261 - 192;
innerVeto(77:80)   = 261 - 193;
innerVeto(70:76)   = 261 - 194;
innerVeto(65:69)   = 261 - 195;
...
% vertical section
aortaSeed(261-132,165,39:40)   = 1;
aortaSeed(261-131,165,41:42)   = 1;
aortaSeed(261-130,164,43:44)   = 1;
aortaSeed(261-129,164,45:46)   = 1;
aortaSeed(261-128,163,47:48)   = 1;
aortaSeed(261-127,163,49)      = 1;
aortaSeed(261-128,163,50:51)   = 1;
aortaSeed(261-127,163,52:53)   = 1;
aortaSeed(261-126,163,54:55)   = 1;
aortaSeed(261-125,163,56:57)   = 1;
aortaSeed(261-124,164,58:63)   = 1;
aortaSeed(261-123,165,64:69)   = 1;
aortaSeed(261-122,165,70:71)   = 1;
aortaSeed(261-121,165,72:73)   = 1;
aortaSeed(261-120,166,74:76)   = 1;
aortaSeed(261-119,167,77:78)   = 1;
aortaSeed(261-118,167,79:80)   = 1;
aortaSeed(261-117,166,81:84)   = 1;
aortaSeed(261-117,166,85:88)   = 1; 
aortaSeed(261-116,166,89:100)   = 1;
aortaSeed(261-117,167,101:103)    = 1;
aortaSeed(261-118,166,104:upperTop) = 1;
% curved section
aortaSeed(261-126,166,105:upperTop) = 1;
aortaSeed(261-134,164,105:upperTop) = 1;
aortaSeed(261-142,157,105:upperTop) = 1;
aortaSeed(261-149,156,105:upperTop) = 1;
aortaSeed(261-146,150,105:upperTop) = 1;
aortaSeed(261-152,149,105:upperTop) = 1;
aortaSeed(261-140,160,106:upperTop) = 1;
aortaSeed(261-134,162,106:upperTop) = 1;
aortaSeed(261-130,165,106:upperTop) = 1;
aortaSeed(261-134,157,107:upperTop) = 1;
...
save subject12_i_registered.mat;