...
NIFTI_file_name_F_upper = '20160218_152737t1vibedixontrap4bh320s004a1001.nii.gz';
NIFTI_file_name_W_upper = '20160218_152737t1vibedixontrap4bh320s005a1001.nii.gz';
NIFTI_file_name_F_lower = '20160218_152737t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_lower = '20160218_152737t1vibedixontrap4bh320s010a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0004/20160218_152737t1vibedixontrap4bh320s004a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0005/20160218_152737t1vibedixontrap4bh320s005a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20160218_152737t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20160218_152737t1vibedixontrap4bh320s010a1001.nii';

NIFTI_file_name_F_upper_reslice = '20160218_152737t1vibedixontrap4bh320s004a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20160218_152737t1vibedixontrap4bh320s005a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20160218_152737t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20160218_152737t1vibedixontrap4bh320s010a1001_resliced.nii';
...
Z_L5_S1b = 66;  % bottom of L5-S1 intervertebral disk slice
Z_L4_L5  = 81;   % middle of L4-L5 intervertebral disk slice
Z_L3_L4  = 94;   % middle of L3-L4 intervertebral disk slice
UM       = 94;   % umbilicus (belly button)
Z_L2_L3  = 108;  % middle of L2-L3 intervertebral disk slice
Z_L1_L2  = 119;  % middle of L1-L2 intervertebral disk slice
%Z_L1_L2t    = 118; % top of L2 vertebra disk
% Z_L1_L2t = 113;  % top of L1-L2 intervertebral disk
lowerTop = 115;
lastSlice = 50;  % lowest slice without clipping

lowerSlices = lowerTop:-1:lowerBottom;

% correct scan offset
scanOffset = 101   %Z_L1_L1 - Z_L1_L1u
...
innerVeto(114:120) = 261 - 182;
innerVeto(113)     = 261 - 183;
innerVeto(112)     = 261 - 184;
innerVeto(111)     = 261 - 185;
innerVeto(109:110) = 261 - 186;
innerVeto(107:108) = 261 - 187;
innerVeto(105:106) = 261 - 188;
innerVeto(103:104) = 261 - 189;
innerVeto(102)     = 261 - 190;
innerVeto(101)     = 261 - 191;
innerVeto(97:100)  = 261 - 192;
innerVeto(95:96)   = 261 - 193;
innerVeto(93:94)   = 261 - 194;
innerVeto(91:92)   = 261 - 195;
innerVeto(88:90)   = 261 - 196;
innerVeto(85:87)   = 261 - 197;
innerVeto(83:84)   = 261 - 198;
innerVeto(81:82)   = 261 - 199;
innerVeto(79:80)   = 261 - 200;
innerVeto(77:78)   = 261 - 201;
innerVeto(75:76)   = 261 - 202;
innerVeto(70:74)   = 261 - 203;
innerVeto(64:69)   = 261 - 204;
...
% vertical section
aortaSeed(261-131,163,40:41)   = 1;
aortaSeed(261-130,163,42:43)   = 1;
aortaSeed(261-129,163,44:45)   = 1;
aortaSeed(261-128,162,46:47)   = 1;
aortaSeed(261-127,162,48:51)   = 1;
aortaSeed(261-126,163,52:54)   = 1;
aortaSeed(261-125,163,55:58)   = 1;
aortaSeed(261-124,163,59:66)   = 1;
aortaSeed(261-123,163,67:69)   = 1;
aortaSeed(261-123,163,70:71)   = 1;
aortaSeed(261-122,163,72:73)   = 1;
aortaSeed(261-121,163,74:76)   = 1;
aortaSeed(261-120,163,77:80)   = 1;
aortaSeed(261-119,162,81:84)   = 1;
aortaSeed(261-118,163,85:96)   = 1;
aortaSeed(261-118,162,97:104)   = 1;
aortaSeed(261-119,163,105:upperTop) = 1;
% curved section
aortaSeed(261-126,166,105:upperTop) = 1;
aortaSeed(261-133,167,105:upperTop) = 1;
aortaSeed(261-139,160,105:upperTop) = 1;
aortaSeed(261-146,162,105:upperTop) = 1;
aortaSeed(261-152,156,105:upperTop) = 1;
aortaSeed(261-149,147,105:upperTop) = 1;
aortaSeed(261-162,149,105:upperTop) = 1;
aortaSeed(261-152,149,106:upperTop) = 1;
aortaSeed(261-139,161,106:upperTop) = 1;
...
save subject09_i_registered.mat;