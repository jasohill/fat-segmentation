...
NIFTI_file_name_F_upper = '20160331_090259t1vibedixontrap4bh320s004a1001.nii.gz';
NIFTI_file_name_W_upper = '20160331_090259t1vibedixontrap4bh320s005a1001.nii.gz';
NIFTI_file_name_F_lower = '20160331_090259t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_lower = '20160331_090259t1vibedixontrap4bh320s010a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0004/20160331_090259t1vibedixontrap4bh320s004a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0005/20160331_090259t1vibedixontrap4bh320s005a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20160331_090259t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20160331_090259t1vibedixontrap4bh320s010a1001.nii';

NIFTI_file_name_F_upper_reslice = '20160331_090259t1vibedixontrap4bh320s004a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20160331_090259t1vibedixontrap4bh320s005a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20160331_090259t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20160331_090259t1vibedixontrap4bh320s010a1001_resliced.nii';
...
upperBottom = 7;
Z_L2_L3u    = 24;
Z_L1_L2u    = 35;  % middle of L1-L2 intervertebral disk slice (upper scan)
Z_T11_T12   = 47;
Z_T10_T11   = 57;
...
lowerBottom = 5;
FH       = 24;  % widest slice of the formoral head
Z_L5_S1b = 67;  % bottom of L5-S1 intervertebral disk slice
...
% correct scan offset
scanOffset = 83   %Z_L1_L1 - Z_L1_L1u
...
innerVeto(115:120) = 261 - 176;
innerVeto(114)     = 261 - 177;
innerVeto(113)     = 261 - 178;
...
innerVeto(89:90)   = 261 - 195;
innerVeto(87:88)   = 261 - 196;
innerVeto(85:86)   = 261 - 197;
innerVeto(83:84)   = 261 - 198;
innerVeto(82)      = 261 - 199;
innerVeto(81)      = 261 - 200;
innerVeto(70:80)   = 261 - 201;
innerVeto(65:69)   = 261 - 202;
...
% vertical section
aortaSeed(261-126,168,40)      = 1;
aortaSeed(261-125,168,41:42)   = 1;
aortaSeed(261-124,168,43:44)   = 1;
aortaSeed(261-123,168,45)      = 1;
aortaSeed(261-122,168,46:47)   = 1;
aortaSeed(261-121,168,48:51)   = 1;
aortaSeed(261-120,168,52:53)   = 1;
aortaSeed(261-120,168,54:57)   = 1;
aortaSeed(261-119,168,58:59)   = 1;
aortaSeed(261-118,168,60:66)   = 1;
aortaSeed(261-117,169,67:69)   = 1;
aortaSeed(261-116,170,70:71)   = 1;
aortaSeed(261-115,169,72:73)   = 1;
aortaSeed(261-115,170,74:76)   = 1;
aortaSeed(261-113,171,77:80)   = 1;
aortaSeed(261-112,171,81:84)   = 1;
aortaSeed(261-112,171,85:90)   = 1; 
aortaSeed(261-112,172,91:100)  = 1;
aortaSeed(261-112,173,101)     = 1;
aortaSeed(261-112,174,102:104) = 1;
aortaSeed(261-113,174,105)     = 1;
aortaSeed(261-115,175,106:upperTop) = 1;
% curved section
aortaSeed(261-116,175,107:upperTop) = 1;
aortaSeed(261-127,174,107:upperTop) = 1;
aortaSeed(261-130,171,107:upperTop) = 1;
aortaSeed(261-136,169,107:upperTop) = 1;
aortaSeed(261-144,166,107:upperTop) = 1;
aortaSeed(261-153,167,107:upperTop) = 1;
aortaSeed(261-146,159,108:upperTop) = 1;
...
save subject14_i_registered.mat;