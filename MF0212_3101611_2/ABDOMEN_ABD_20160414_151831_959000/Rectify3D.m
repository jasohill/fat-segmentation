...
NIFTI_file_name_F_upper = '20160414_151831t1vibedixontrap4bh320s004a1001.nii.gz';
NIFTI_file_name_W_upper = '20160414_151831t1vibedixontrap4bh320s005a1001.nii.gz';
NIFTI_file_name_F_lower = '20160414_151831t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_lower = '20160414_151831t1vibedixontrap4bh320s010a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0004/20160414_151831t1vibedixontrap4bh320s004a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0005/20160414_151831t1vibedixontrap4bh320s005a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20160414_151831t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20160414_151831t1vibedixontrap4bh320s010a1001.nii';

NIFTI_file_name_F_upper_reslice = '20160414_151831t1vibedixontrap4bh320s004a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20160414_151831t1vibedixontrap4bh320s005a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20160414_151831t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20160414_151831t1vibedixontrap4bh320s010a1001_resliced.nii';
...
Z_T10_T11   = 49;  % middle of T10-T11 intervertebral disk (use for bottom of thoracic cavity)
Z_T9_T10t   = 59;  % top of T10 vertebra disk slice (use for bottom of thoracic cavity) 
Z_T4_T5t    = 103; % top of T4-T5 intervertebral disk slice
upperTop = 111;

% NOTE: diaphraim is at slices = 
% - register from the bottom of T8
heartMax    = upperTop-70+1;
heartApex = upperTop-59+1;
diaphram    = upperTop-Z_T9_T10t+1; 

upperSlices = upperTop:-1:upperBottom;

lowerBottom = 4;
FH       = 31;  % widest slice of the formoral head
Z_L5_S1b = 69;  % bottom of L5-S1 intervertebral disk slice
Z_L4_L5  = 86;   % middle of L4-L5 intervertebral disk slice
Z_L3_L4  = 99;   % middle of L3-L4 intervertebral disk slice
UM       = 89;   % umbilicus (belly button)
Z_L2_L3  = 111;  % middle of L2-L3 intervertebral disk slice
Z_L1_L2  = 122;  % middle of L1-L2 intervertebral disk slice
lowerTop = 117;
lastSlice = 34;  % lowest slice without clipping

lowerSlices = lowerTop:-1:lowerBottom;

% correct scan offset
scanOffset = 107   %Z_L2_L3 - Z_L2_L3u
...
innerVeto(114:113) = 261 - 178;
innerVeto(111:112) = 261 - 179;
innerVeto(110:111) = 261 - 180;
innerVeto(109)     = 261 - 182;
innerVeto(107:108) = 261 - 183;
innerVeto(106)     = 261 - 184;
innerVeto(105)     = 261 - 185;
innerVeto(103:104) = 261 - 186;
innerVeto(101:102) = 261 - 187;
innerVeto(100)     = 261 - 188;
innerVeto(99)      = 261 - 189;
innerVeto(98)      = 261 - 190;
innerVeto(97)      = 261 - 191;
innerVeto(95:96)   = 261 - 192;
innerVeto(93:94)   = 261 - 193;
innerVeto(91:92)   = 261 - 194;
innerVeto(85:90)   = 261 - 195;
innerVeto(81:84)   = 261 - 196;
innerVeto(70:80)   = 261 - 197;
...
% vertical section
aortaSeed(261-134,167,39:40)   = 1;
aortaSeed(261-133,167,41:42)   = 1;
aortaSeed(261-132,167,43:44)   = 1;
aortaSeed(261-131,167,45:46)   = 1;
aortaSeed(261-130,166,47:48)   = 1;
aortaSeed(261-129,166,49)     = 1;
aortaSeed(261-128,166,50:55)   = 1;
aortaSeed(261-127,166,56:57)   = 1;
aortaSeed(261-126,166,58:62)   = 1;
aortaSeed(261-125,167,63:69)   = 1;
aortaSeed(261-124,167,70:71)   = 1;
aortaSeed(261-123,167,72:73)   = 1;
aortaSeed(261-121,168,74:76)   = 1;
aortaSeed(261-120,169,77:78)   = 1;
aortaSeed(261-119,170,79:80)   = 1;
aortaSeed(261-118,169,81:84)   = 1;
aortaSeed(261-118,170,85:88)   = 1; 
aortaSeed(261-117,170,89:100)   = 1;
aortaSeed(261-117,170,101:103)    = 1;
aortaSeed(261-118,169,104:upperTop) = 1;
% curved section
aortaSeed(261-126,169,105:upperTop) = 1;
aortaSeed(261-134,167,105:upperTop) = 1;
aortaSeed(261-134,170,106:upperTop) = 1;
aortaSeed(261-142,160,105:upperTop) = 1;
aortaSeed(261-149,159,105:upperTop) = 1;
aortaSeed(261-146,153,105:upperTop) = 1;
aortaSeed(261-152,152,105:upperTop) = 1;
aortaSeed(261-152,157,106:upperTop) = 1;
aortaSeed(261-140,163,106:upperTop) = 1;
aortaSeed(261-134,165,106:upperTop) = 1;
aortaSeed(261-130,168,106:upperTop) = 1;
aortaSeed(261-132,160,107:upperTop) = 1;
aortaSeed(261-145,156,107:upperTop) = 1;
...
save subject12_f_registered.mat;