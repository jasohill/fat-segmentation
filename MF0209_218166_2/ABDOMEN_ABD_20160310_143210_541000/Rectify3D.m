...
NIFTI_file_name_F_upper = '20160310_143210t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_upper = '20160310_143210t1vibedixontrap4bh320s010a1001.nii.gz';
NIFTI_file_name_F_lower = '20160310_143210t1vibedixontrap4bh320s014a1001.nii.gz';
NIFTI_file_name_W_lower = '20160310_143210t1vibedixontrap4bh320s015a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20160310_143210t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20160310_143210t1vibedixontrap4bh320s010a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0014/20160310_143210t1vibedixontrap4bh320s014a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0015/20160310_143210t1vibedixontrap4bh320s015a1001.nii';

NIFTI_file_name_F_upper_reslice = '20160310_143210t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20160310_143210t1vibedixontrap4bh320s010a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20160310_143210t1vibedixontrap4bh320s014a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20160310_143210t1vibedixontrap4bh320s015a1001_resliced.nii';
...
Z_T4_T5t    = 109; % top of T4-T5 intervertebral disk slice
...
lowerBottom = 4;
FH       = 15;  % widest slice of the formoral head
Z_L5_S1b = 56;  % bottom of L5-S1 intervertebral disk slice
...
Z_L2_L3  = 100;  % middle of L2-L3 intervertebral disk slice
Z_L1_L2  = 112;  % middle of L1-L2 intervertebral disk slice
lowerTop = 117;
lastSlice = 55;  % lowest slice without clipping
...
vetoFactorF = 6.5; %4.5
vetoFactorW = 6.5; %3.5
foregroundThreshold1  = 65; %45 %74; %59
...
innerVeto(114:120) = 261 - 183;
innerVeto(113)     = 261 - 184;
innerVeto(112)     = 261 - 185;
innerVeto(111)     = 261 - 186;
innerVeto(109:110) = 261 - 187;
innerVeto(107:108) = 261 - 188;
innerVeto(105:106) = 261 - 189;
innerVeto(103:104) = 261 - 190;
innerVeto(102)     = 261 - 191;
innerVeto(101)     = 261 - 192;
innerVeto(97:100)  = 261 - 193;
innerVeto(95:96)   = 261 - 194;
innerVeto(93:94)   = 261 - 195;
innerVeto(91:92)   = 261 - 196;
innerVeto(88:90)   = 261 - 197;
innerVeto(85:87)   = 261 - 198;
innerVeto(83:84)   = 261 - 199;
innerVeto(81:82)   = 261 - 200;
innerVeto(79:80)   = 261 - 201;
innerVeto(77:78)   = 261 - 202;
innerVeto(75:76)   = 261 - 203;
innerVeto(70:74)   = 261 - 204;
innerVeto(64:69)   = 261 - 205;
...
% vertical section
aortaSeed(261-133,163,40:41)   = 1;
aortaSeed(261-132,164,42:43)   = 1;
aortaSeed(261-131,164,44:45)   = 1;
aortaSeed(261-130,164,46)      = 1;
aortaSeed(261-129,164,47:48)   = 1;
aortaSeed(261-128,165,49:51)   = 1;
aortaSeed(261-127,165,52:53)   = 1;
aortaSeed(261-126,165,54:55)   = 1;
aortaSeed(261-125,166,56:58)   = 1;
aortaSeed(261-124,167,59:66)   = 1;
aortaSeed(261-123,167,67:69)   = 1;
aortaSeed(261-123,167,70:71)   = 1;
aortaSeed(261-123,168,72:73)   = 1;
aortaSeed(261-123,168,74:76)   = 1;
aortaSeed(261-123,169,77:80)   = 1;
aortaSeed(261-121,169,81:84)   = 1;
aortaSeed(261-120,169,85:96)   = 1;
aortaSeed(261-120,170,97:103)   = 1;
aortaSeed(261-121,171,104:upperTop) = 1;
% curved section
aortaSeed(261-128,174,104:upperTop) = 1;
aortaSeed(261-135,175,104:upperTop) = 1;
aortaSeed(261-141,168,104:upperTop) = 1;
aortaSeed(261-148,170,104:upperTop) = 1;
aortaSeed(261-154,164,104:upperTop) = 1;
aortaSeed(261-151,155,104:upperTop) = 1;
aortaSeed(261-164,157,104:upperTop) = 1;
aortaSeed(261-154,157,104:upperTop) = 1;
aortaSeed(261-141,169,105:upperTop) = 1;
...
save subject09_f_registered.mat;