...
NIFTI_file_name_F_upper = '20160419_151055t1vibedixontrap4bh320s004a1001.nii.gz';
NIFTI_file_name_W_upper = '20160419_151055t1vibedixontrap4bh320s005a1001.nii.gz';
NIFTI_file_name_F_lower = '20160419_151055t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_lower = '20160419_151055t1vibedixontrap4bh320s010a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0004/20160419_151055t1vibedixontrap4bh320s004a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0005/20160419_151055t1vibedixontrap4bh320s005a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20160419_151055t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20160419_151055t1vibedixontrap4bh320s010a1001.nii';

NIFTI_file_name_F_upper_reslice = '20160419_151055t1vibedixontrap4bh320s004a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20160419_151055t1vibedixontrap4bh320s005a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20160419_151055t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20160419_151055t1vibedixontrap4bh320s010a1001_resliced.nii';
...
Z_T11_T12   = 46;
Z_T10_T11   = 57;
Z_T9_T10t   = 68;  % top of T10 vertebra disk slice (use for bottom of thoracic cavity) 
Z_T4_T5t    = 110; % top of T4-T5 intervertebral disk slice
upperTop = 111;

% NOTE: diaphraim is at slices = 
% - register from the bottom of T8
heartMax    = upperTop - 67 + 1;
...
lowerBottom = 5;
FH       = 29;  % widest slice of the formoral head
Z_L5_S1b = 69;  % bottom of L5-S1 intervertebral disk slice
Z_L4_L5  = 87;   % middle of L4-L5 intervertebral disk slice
UM       = 91;   % umbilicus (belly button)
Z_L3_L4  = 101;   % middle of L3-L4 intervertebral disk slice
Z_L2_L3  = 114;  % middle of L2-L3 intervertebral disk slice
%Z_L1_L2  = 115;  % middle of L1-L2 intervertebral disk slice
lowerTop = 116;
lastSlice = 66;  % lowest slice without clipping

lowerSlices = lowerTop:-1:lowerBottom;

% correct scan offset
scanOffset = 105;   %Z_L2_L3 - Z_L2_L3
...
innerVeto(112:120) = 261 - 174;
innerVeto(111)     = 261 - 175;
innerVeto(110)     = 261 - 176;
innerVeto(109)     = 261 - 178;
innerVeto(108)     = 261 - 180;
innerVeto(107)     = 261 - 182;
...
innerVeto(96)      = 261 - 193;
innerVeto(95)      = 261 - 194;
innerVeto(93:94)   = 261 - 195;
innerVeto(91:92)   = 261 - 196;
innerVeto(90)      = 261 - 197;
innerVeto(89)      = 261 - 198;
innerVeto(87:88)   = 261 - 199;
innerVeto(85:86)   = 261 - 200;
innerVeto(84)      = 261 - 201;
innerVeto(83)      = 261 - 202;
innerVeto(82)      = 261 - 203;
innerVeto(81)      = 261 - 204;
innerVeto(70:80)   = 261 - 205;
...
% vertical section
aortaSeed(261-119,168,40:41)   = 1;
aortaSeed(261-118,168,42)      = 1;
aortaSeed(261-117,168,43)      = 1;
aortaSeed(261-116,167,44:47)   = 1;
aortaSeed(261-115,167,48:51)   = 1;
aortaSeed(261-115,167,52:54)   = 1;
aortaSeed(261-114,167,55:58)   = 1;
aortaSeed(261-113,166,59:66)   = 1;
aortaSeed(261-112,166,67:69)   = 1;
aortaSeed(261-111,166,70:71)   = 1;
aortaSeed(261-111,166,72:75)   = 1;
aortaSeed(261-110,166,76:79)   = 1;
aortaSeed(261-109,166,80:81)   = 1;
aortaSeed(261-109,167,82:84)   = 1;
aortaSeed(261-109,166,85:89)   = 1; 
aortaSeed(261-108,166,90:96)   = 1;
aortaSeed(261-110,166,97:98)   = 1;
aortaSeed(261-111,166,99:100)  = 1;
aortaSeed(261-111,166,101)     = 1;
aortaSeed(261-112,166,102:upperTop) = 1;
% curved section
aortaSeed(261-117,166,103:upperTop) = 1;
aortaSeed(261-124,166,103:upperTop) = 1;
aortaSeed(261-129,157,103:upperTop) = 1;
aortaSeed(261-135,152,103:upperTop) = 1;
aortaSeed(261-142,150,103:upperTop) = 1;
aortaSeed(261-146,155,103:upperTop) = 1;
...
[tiltAngleLo,rotAngleLo] = Find_table_tilt_angle(Blo, voxelSize_lo,[4,70],[],false); %[20,60] %60 % [20,first_lower_l]
tiltAngleLo
rotAngleLo
...
Blo_reslice = Make_DIXON_threshold_image(niiFlo_reslice.img,niiWlo_reslice.img);
[tiltAngleLo_reslice,rotAngleLo_reslice] = Find_table_tilt_angle(Blo_reslice, voxelSize_lo,[4,70],[],false); %[20,60] %[55,115]  %[20,first_lower_l]
tiltAngleLo_reslice
rotAngleLo_reslice
...
save subject15_f_registered.mat;