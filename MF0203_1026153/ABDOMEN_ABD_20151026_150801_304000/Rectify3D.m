...
NIFTI_file_name_F_upper = '20151026_150801t1vibedixontrap4bh320s004a1001.nii.gz';
NIFTI_file_name_W_upper = '20151026_150801t1vibedixontrap4bh320s005a1001.nii.gz';
NIFTI_file_name_F_lower = '20151026_150801t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_lower = '20151026_150801t1vibedixontrap4bh320s010a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0004/20151026_150801t1vibedixontrap4bh320s004a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0005/20151026_150801t1vibedixontrap4bh320s005a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20151026_150801t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20151026_150801t1vibedixontrap4bh320s010a1001.nii';

NIFTI_file_name_F_upper_reslice = '20151026_150801t1vibedixontrap4bh320s004a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20151026_150801t1vibedixontrap4bh320s005a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20151026_150801t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20151026_150801t1vibedixontrap4bh320s010a1001_resliced.nii';
...
voxelSize_lo = [1.40625, 1.40625, 2.4680];
voxelVolume_lo = prod(voxelSize_lo)*(1+interslice_spacing_fraction);
% X_shift = round(4.5/voxelSize_lower(1));
% Y_shift = 0;
% X_shift2 = 0;
% Y_shift2 = round(15.6/voxelSize_upper(2));
...
upperBottom = 7;
Z_L2_L3u    = 5;  % middle of L2-L3 intervertebral disk slice (upper scan)
Z_L1_L2u    = 18; % middle of L1-L2 intervertebral disk slice (upper scan)
% Z_L2        = 5;  % bottom of L2 vertebra slice
Z_T4_T5t    = 118; % top of T4-T5 intervertebral disk slice
Z_T9_T10    = 65; 
Z_T10_T11t  = 53;  % top of T10-T11 vertebra disk slice (use for bottom of thoracic cavity) 
upperTop = 114;
...
heartApex = upperTop-64+1;
diaphram  = upperTop-Z_T10_T11t+1; 

lowerBottom = 5;
FH        = 11;  % widest slice of the formoral head
Z_L5_S1b  = 49;   % bottom of L5-S1 intervertebral disk slice
lastSlice = 58;  % last slice with no clipping
Z_L4_L5   = 68;   % middle of L4-L5 intervertebral disk slice
Z_L3_L4   = 83;   % middle of L3-L4 intervertebral disk slice
UM        = 85;   % umbilicus (belly button)
Z_L2_L3   = 98;  % middle of L2-L3 intervertebral disk slice
%Z_L3d = 100;  % top of L2 vertebra disk
...
% correct scan offset
scanOffset = 93   %Z_L1_L1 - Z_L1_L1u
...
innerVeto(115:120) = 261 - 181;
innerVeto(114)     = 261 - 183;
innerVeto(113)     = 261 - 185;
innerVeto(112)     = 261 - 188;
innerVeto(111)     = 261 - 189;
innerVeto(110)     = 261 - 190;
innerVeto(109)     = 261 - 191;
innerVeto(108)     = 261 - 192;
innerVeto(107)     = 261 - 194;
innerVeto(106)     = 261 - 195;
innerVeto(105)     = 261 - 197;
innerVeto(104)     = 261 - 198;
innerVeto(103)     = 261 - 199;
innerVeto(102)     = 261 - 200;
innerVeto(101)     = 261 - 201;
innerVeto(99:100)  = 261 - 202;
innerVeto(97:98)   = 261 - 203;
innerVeto(96)      = 261 - 204;
innerVeto(95)      = 261 - 205;
innerVeto(93:94)   = 261 - 206;
innerVeto(91:92)   = 261 - 207;
innerVeto(88:90)   = 261 - 208;
innerVeto(85:87)   = 261 - 209;
innerVeto(79:84)   = 261 - 210;
innerVeto(77:78)   = 261 - 211;
innerVeto(75:76)   = 261 - 212;
innerVeto(70:74)   = 261 - 213;
innerVeto(65:69)   = 261 - 214;
...
% vertical section
aortaSeed(261-125,160,40:43)   = 1;
aortaSeed(261-122,160,44:47)   = 1;
aortaSeed(261-119,159,48:51)   = 1;
aortaSeed(261-117,159,52:54)   = 1;
aortaSeed(261-115,158,55:61)   = 1;
aortaSeed(261-113,158,62:66)   = 1;
aortaSeed(261-112,158,67:69)   = 1;
aortaSeed(261-111,158,70:71)   = 1;
aortaSeed(261-110,158,72:73)   = 1;
aortaSeed(261-109,158,74:76)   = 1;
aortaSeed(261-108,158,77:80)   = 1;
aortaSeed(261-107,158,81:84)   = 1;
aortaSeed(261-106,158,85:90)   = 1; 
aortaSeed(261-105,159,91:92)   = 1;
aortaSeed(261-104,159,93:96)   = 1;
aortaSeed(261-104,160,97:100)  = 1;
aortaSeed(261-104,160,101:103) = 1;
aortaSeed(261-104,160,104:107) = 1;
aortaSeed(261-105,161,108)     = 1;
aortaSeed(261-106,162,109:110) = 1;
% curved section
aortaSeed(261-105,162,111:upperTop) = 1;
aortaSeed(261-113,164,111:upperTop) = 1;
aortaSeed(261-115,164,111:upperTop) = 1;
aortaSeed(261-119,164,111:upperTop) = 1;
aortaSeed(261-124,161,111:upperTop) = 1;
aortaSeed(261-130,159,111:upperTop) = 1;
aortaSeed(261-135,156,111:upperTop) = 1;
aortaSeed(261-143,155,111:upperTop) = 1;
aortaSeed(261-139,149,111:upperTop) = 1;
...
[tiltAngleLo,rotAngleLo] = Find_table_tilt_angle(Blo, voxelSize_lo,[5,75],[],false); %[20,60] %60 % [20,first_lower_l]
tiltAngleLo
rotAngleLo
...
Blo_reslice = Make_DIXON_threshold_image(niiFlo_reslice.img,niiWlo_reslice.img);
[tiltAngleLo_reslice,rotAngleLo_reslice] = Find_table_tilt_angle(Blo_reslice, voxelSize_lo,[5,75],[],false); %[20,60] %[55,115]  %[20,first_lower_l]
tiltAngleLo_reslice
rotAngleLo_reslice
...
save subject03_i_registered.mat;