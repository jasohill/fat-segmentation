...
NIFTI_file_name_F_upper = '20160419_151941t1vibedixontrap4bh320s009a1001.nii.gz';
NIFTI_file_name_W_upper = '20160419_151941t1vibedixontrap4bh320s010a1001.nii.gz';
NIFTI_file_name_F_lower = '20160419_151941t1vibedixontrap4bh320s014a1001.nii.gz';
NIFTI_file_name_W_lower = '20160419_151941t1vibedixontrap4bh320s015a1001.nii.gz';

NIFTI_file_name_F_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0009/20160419_151941t1vibedixontrap4bh320s009a1001.nii';
NIFTI_file_name_W_upper_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0010/20160419_151941t1vibedixontrap4bh320s010a1001.nii';
NIFTI_file_name_F_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_F_0014/20160419_151941t1vibedixontrap4bh320s014a1001.nii';
NIFTI_file_name_W_lower_NII = 'T1_VIBE_DIXON_TRA_P4_BH_320_W_0015/20160419_151941t1vibedixontrap4bh320s015a1001.nii';

NIFTI_file_name_F_upper_reslice = '20160419_151941t1vibedixontrap4bh320s009a1001_resliced.nii';
NIFTI_file_name_W_upper_reslice = '20160419_151941t1vibedixontrap4bh320s010a1001_resliced.nii';
NIFTI_file_name_F_lower_reslice = '20160419_151941t1vibedixontrap4bh320s014a1001_resliced.nii';
NIFTI_file_name_W_lower_reslice = '20160419_151941t1vibedixontrap4bh320s015a1001_resliced.nii';
...
heartMax    = upperTop - 80+1;
heartApex   = upperTop - 62+1;
diaphram    = upperTop - Z_T10_T11 + 1; 

upperSlices = upperTop:-1:upperBottom;

lowerBottom = 3;
FH       = 26;  % widest slice of the formoral head
Z_L5_S1b = 65;  % bottom of L5-S1 intervertebral disk slice
Z_L4_L5  = 79;   % middle of L4-L5 intervertebral disk slice
Z_L3_L4  = 92;   % middle of L3-L4 intervertebral disk slice
UM       = 82;   % umbilicus (belly button)
Z_L2_L3  = 105;  % middle of L2-L3 intervertebral disk slice
Z_L1_L2  = 116;  % middle of L1-L2 intervertebral disk slicek
lowerTop = 116;
lastSlice = 106;  % lowest slice without clipping

lowerSlices = lowerTop:-1:lowerBottom;

% correct scan offset
scanOffset = 94   %Z_L1_L1 - Z_L1_L1u
...
aortaThreshold = 55;     % threshold of 8-bit water dominated signal data
aortaMinArea   = 60;
aortaDistance  = 50;
aortaRadius    = 9;
...
%CATdilateCorrect(heartApex-1:heartApex) = -3; 
...
% vertical section
aortaSeed(261-136,166,40:41)   = 1;
aortaSeed(261-135,166,42:43)   = 1;
aortaSeed(261-134,166,44:45)   = 1;
aortaSeed(261-133,167,46:47)   = 1;
aortaSeed(261-132,167,48:51)   = 1;
aortaSeed(261-131,168,52:53)   = 1;
aortaSeed(261-130,168,54:55)   = 1;
aortaSeed(261-129,169,56:57)   = 1;
aortaSeed(261-128,169,58:59)   = 1;
aortaSeed(261-127,169,60:61)   = 1;
aortaSeed(261-126,170,62:63)   = 1;
aortaSeed(261-125,170,64:65)   = 1;
aortaSeed(261-124,171,66:67)   = 1;
aortaSeed(261-123,172,68:69)   = 1;
aortaSeed(261-122,173,70:71)   = 1;
aortaSeed(261-121,172,72:73)   = 1;
aortaSeed(261-120,172,74:75)   = 1;
aortaSeed(261-119,173,76:77)   = 1;
aortaSeed(261-118,174,78:79)   = 1;
aortaSeed(261-117,175,80:83)   = 1;
aortaSeed(261-116,175,84:85)   = 1;
aortaSeed(261-115,175,86:87)   = 1;
aortaSeed(261-114,174,88:89)   = 1;
aortaSeed(261-113,175,90:92)   = 1;
aortaSeed(261-113,174,93:97)   = 1;
aortaSeed(261-112,174,94)      = 1;
aortaSeed(261-113,175,95:96)   = 1;
aortaSeed(261-112,174,97:102)  = 1;
aortaSeed(261-112,175,103:upperTop)  = 1;
% curved section
aortaSeed(261-124,177,106:upperTop) = 1;
aortaSeed(261-134,175,106:upperTop) = 1;
aortaSeed(261-134,175,106:upperTop) = 1;
aortaSeed(261-142,164,106:upperTop) = 1;
aortaSeed(261-143,157,106:upperTop) = 1;
aortaSeed(261-141,157,107:upperTop) = 1;
aortaSeed(261-134,171,107:upperTop) = 1;
aortaSeed(261-128,170,109:upperTop) = 1;
aortaSeed(261-118,175,109:upperTop) = 1;
aortaSeed(261-143,157,109:upperTop) = 1;
...
BloCoM = center_of_mass(Blo>0.5) %#ok<NASGU>
BloShowSliceCoM = center_of_mass(Blo(:,:,showSliceLo)>0.5) %#ok<NASGU>
...
figure, imshow(fliplr(rot90(niiFlo_reslice.img(:,:,showSliceLo))),[]);
    ...
    [V_F_lo_reslice,Y_F_lo_reslice] = STANCE_load_volume(NIFTI_file_name_F_lower);
    V_F_lo_reslice.fname = NIFTI_file_name_F_lower_reslice;
    niiFlo_reslice = niiFlo;
end
...
niiWlo_reslice = load_nii(NIFTI_file_name_W_lower_reslice);
    ...
    [V_W_lo_reslice,Y_W_lo_reslice] = STANCE_load_volume(NIFTI_file_name_W_lower);
    V_W_lo_reslice.fname = NIFTI_file_name_W_lower_reslice;
    niiWlo_reslice = niiWlo;
end
...
save subject13_f_registered.mat;