...
upperBottom = 6;
Z_L1_L2u    = 10;  % middle of L1-L2 intervertebral disk slice (upper scan)
%Z_L1       = 13;  % bottom of L1 vertebra slice
Z_T9_T10    = 46;  % top of T4-T5 intervertebral disk slice
Z_T8_T9     = 57;  % middle of T8-T9 vertebra disk slice (use for bottom of thoracic cavity) 
upperTop    = 110;
...
% Z_T12_T11  = 34; %X_T12_T11 = 163; Y_T12_T11 = 109;
% Z_T11_T10  = 46; %X_T11_T10 = 164; Y_T11_T10 = 104;
% Z_T10_T9  = 57; %X_T10_T9 = 164; Y_T10_T9 = 99;
% Z_T9_T8  = 66; %X_T9_T8 = 164; Y_T9_T8 = 97;
% Z_T8_T7  = 76; %X_T8_T7 = 164; Y_T8_T7 = 94;
% Z_T7_T6  = 84; %X_T7_T6 = 164; Y_T7_T6 = 94;
% Z_T6_T5  = 93; %X_T6_T5 = 164; Y_T6_T5 = 93;
% Z_T5_T4  = 101;%X_T5_T4 = 164; Y_T5_T4 = 91;
% Z_T4_T3  = 108; %X_T4_T3 = 164; Y_T4_T3 = 91;
% Z_T3_T2  = 117; %X_T3_T2 = 164; Y_T3_T2 = 96;
% Z_T2_T1  = 
% Z_T1_C7  =
% Z_C7_C6  =
% Z_C6_C5  =
...
innerVeto(115:120) = 261 - 194;
innerVeto(114)     = 261 - 195;
innerVeto(113)     = 261 - 196;
innerVeto(112)     = 261 - 197;
innerVeto(111)     = 261 - 198;
innerVeto(110)     = 261 - 199;
innerVeto(109)     = 261 - 200;
innerVeto(108)     = 261 - 201;
innerVeto(107)     = 261 - 202;
innerVeto(105:106) = 261 - 203;
innerVeto(104)     = 261 - 204;
innerVeto(103)     = 261 - 205;
innerVeto(101:102) = 261 - 206;
innerVeto(99:100)  = 261 - 207;
innerVeto(96:98)   = 261 - 208;
innerVeto(95)      = 261 - 209;
innerVeto(93:94)   = 261 - 210;
innerVeto(91:92)   = 261 - 211;
innerVeto(88:90)   = 261 - 212;
innerVeto(70:87)   = 261 - 213;
...
% vertical section
aortaSeed(261-137,165,35)   = 1;
aortaSeed(261-136,165,36:37)   = 1;
aortaSeed(261-135,165,38:39)   = 1;
aortaSeed(261-134,165,40:42)   = 1;
aortaSeed(261-133,165,43:44)   = 1;
aortaSeed(261-132,165,45:46)   = 1;
aortaSeed(261-131,165,47:48)   = 1;
aortaSeed(261-130,165,49:51)   = 1;
aortaSeed(261-130,165,52:54)   = 1;
aortaSeed(261-129,166,55:58)   = 1;
aortaSeed(261-127,166,59:66)   = 1;
aortaSeed(261-126,167,67:69)   = 1;
aortaSeed(261-125,167,70:71)   = 1;
aortaSeed(261-124,167,72:73)   = 1;
aortaSeed(261-123,167,74:76)   = 1;
aortaSeed(261-122,167,77:80)   = 1;
aortaSeed(261-121,167,81:84)   = 1;
aortaSeed(261-120,167,85:90)   = 1; 
aortaSeed(261-120,168,91:96)   = 1;
aortaSeed(261-120,169,97:98)   = 1;
aortaSeed(261-121,169,99:100)  = 1;
aortaSeed(261-122,169,101)     = 1;
aortaSeed(261-123,169,102)     = 1;
% curved section
aortaSeed(261-123,170,103:upperTop) = 1;
aortaSeed(261-128,171,104:upperTop) = 1;
aortaSeed(261-131,169,107:upperTop) = 1;
aortaSeed(261-138,167,107:upperTop) = 1;
aortaSeed(261-144,163,107:upperTop) = 1;
aortaSeed(261-146,158,107:upperTop) = 1;
aortaSeed(261-146,153,107:upperTop) = 1;
aortaSeed(261-158,151,107:upperTop) = 1;
aortaSeed(261-138,165,108:upperTop) = 1;
...
save subject01_i_registered.mat;